function saveReview() {
    ...
    $.ajax({
        url: 'http://abh-restaurants-backend.herokuapp.com/users/id',
        type: 'get',
        ...
        success:function(response){
            ...
            $.ajax({
                url: 'http://abh-restaurants-backend.herokuapp.com/restaurants/name',
                type: 'get',
                dataType: 'json',
                ...
                success: function (responseRest) {
                    ...
                    $.ajax({
                        url: 'http://abh-restaurants-backend.herokuapp.com/reviews',
                        type: 'post',
                        dataType: 'json',
